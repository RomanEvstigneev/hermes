...
**Slack setup shortcut (v0.11.0+):** Generate a complete Slack app manifest:

```
hermes slack manifest --write
```

Writes to `$HERMES_HOME/slack-manifest.json`. Paste at api.slack.com/apps -> Create New App -> From an app manifest.

To emit only the slash-commands array:
```
